...
def request_otp():
    ...
    try:
        ...
        flash(
            ...
            "Render me BREVO_API_KEY aur "
            "BREVO_FROM check karo.",
            "error",
        )
...
def verify_otp():
    ...
    try:
        ...
        flash(
            "Email verified, but account setup "
    ...
    # ========================================================
    # IMPORTANT:
    # OTP LOGIN KE BAAD PUBLIC HOME NAHI,
    # MEMBER HOME KHULEGA.
    # ========================================================
